        ...
        <form action="{{ route('admin.comics.update', $comic) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="title" id="title" aria-describedby="titleHelper"
                    placeholder="Spideman" value="{{ old('title', $comic->title) }}" />
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control" name="price" id="price"
                    aria-describedby="priceHelper" placeholder="10.99" value="{{ old('price', $comic->price) }}" />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="series" id="series" aria-describedby="seriesHelper"
                    placeholder="Spireman 001" value="{{ old('series', $comic->series) }}" />
